...
describe AccountsController do
  ...
  let(:valid_attributes) { { "name" => "My Account" } }
  ...
  describe "GET index" do
    it "assigns all accounts as @accounts" do
      ...
      get :index
      expect(assigns(:accounts).include?(account)).to be_true
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved account as @account" do
        ...
        user.accounts.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested account" do
        ...
        user.accounts.any_instance.should_receive(:update).with({ "name" => "MyString" })
