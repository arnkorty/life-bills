...
describe PeopleController do
  ...
  # adjust the attributes here as well.
   let(:valid_attributes) { { "name" => "My person" } }
  ...
  describe "GET index" do
    it "assigns all people as @people" do
      person = user.people.create! valid_attributes
      get :index
      expect(assigns(:people).include?(person)).to be_true
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved person as @person" do
        ...
        user.people.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested person" do
        ...
        user.people.any_instance.should_receive(:update).with({ "name" => "MyString" })
